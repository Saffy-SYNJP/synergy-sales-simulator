...
const PROSPECT = [
  { icon: "📞", label: "Open Call", text: "Hi, this is the team from Synergy Lubricants. I wanted to introduce you to something that could meaningfully reduce your cost per litre without compromising quality. Do you have 2 minutes?" },
  ...
  { icon: "💰", label: "Price Reframe", text: "I hear you on price, but let me ask — if the quality is identical to Castrol and you make more margin per litre, is this actually about price or about trust? Let me prove the trust part." },
  { icon: "📄", label: "Certifications", text: "We're fully API certified, and I can send TDS and MSDS for every grade today. Would SJ, SL, SM, SN on the petrol side and CI-4 through CK-4 on diesel cover what your customers need?" },
];
...
const DEMO = [
  ...
  { icon: "🏦", label: "Credit Terms", text: "I need 60-90 day credit terms — upfront payment is impossible for me." },
  { icon: "⏰", label: "Call Later", text: "This is not a good time — call me again in 3 months." },
  { icon: "🤝", label: "Need Approval", text: "I need to consult my business partner before making any decision." },
  { icon: "❓", label: "Prove Quality", text: "How do I know your quality is consistent batch to batch?" },
];
...
const COACH = [
  ...
  { icon: "", label: "Brand", text: "How do I reframe the 'I already have my own brand' objection?" },
  ...
  { icon: "", label: "Language Switch", text: "How should I react when a prospect switches to their local language?" },
  { icon: "", label: "Certifications", text: "How do I leverage API certification and TDS/MSDS in my pitch?" },
];
    ...
    <div className="flex gap-2 flex-wrap">
      {items.map((it) => (
        <button
          ...
          className="px-2.5 py-1.5 text-xs rounded border border-navy-surface bg-navy-surface hover:border-gold hover:text-gold transition"
        >
          {it.icon} {it.label}
        </button>
      ))}
